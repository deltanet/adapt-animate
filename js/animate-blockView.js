    ...
    var AnimateBlockView = Backbone.View.extend({
        ...
        addClasses: function() {
          if (this.titleEnabled) {
            ...
            $(this.modelID).find(".block-title-inner").addClass("animate-hidden");
          }

          if (this.bodyEnabled) {
            $(this.modelID).find(".block-body-inner").addClass("animated");
            $(this.modelID).find(".block-body-inner").addClass("animate-hidden");
          }

          if (this.instructionEnabled) {
            $(this.modelID).find(".block-instruction-inner").addClass("animated");
            $(this.modelID).find(".block-instruction-inner").addClass("animate-hidden");
          }
        ...
        animateElements: function () {
          ...
          if (this.titleEnabled) {
            ...
            _.delay(_.bind(function() {
              ...
              $(this.modelID).find(".block-title-inner").removeClass("animate-hidden");
          ...
          if (this.bodyEnabled) {
            ...
            _.delay(_.bind(function() {
              ...
              $(this.modelID).find(".block-body-inner").removeClass("animate-hidden");
          ...
          if (this.instructionEnabled) {
            ...
            _.delay(_.bind(function() {
              ...
              $(this.modelID).find(".block-instruction-inner").removeClass("animate-hidden");
